# Awesome Bitcoin Culture [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of human creative work about Bitcoin — film, visual art, sculpture, literature,
> music, and the events that gather this scene together.
...
sculpture, music, and long-form media that engages with Bitcoin's ideas, history, or community.
This is not a directory of financial products, exchanges, or speculative collectible drops.
...
2. **Attributable to a named human creator or identifiable studio/collective** — not an
   anonymous generative contract. (Memes & Internet Culture is the one deliberate exception —
   see that section.)
...
coins, AI-slop generated in bulk.
...
- [🎨 Visual Art](#visual-art)
  ...
  - [Painters](#painters)
  - [Digital & Graphic Artists](#digital--graphic-artists)
  - [Mixed Media & Other Artists](#mixed-media--other-artists)
  - [Other / Studio & Sidework](#other--studio--sidework)
...
- [Pepenardo (Nardo)](https://scarce.city) — Oil painting, classical technique meets meme culture.
...
- [RYR](https://www.ryrstudio.com/) — Painting, street art, and contemporary mixed media; retains
  graffiti's raw energy while addressing money, value, and technology. ([X/Twitter](https://x.com/ryrartist))
...
- [Kenneth Burris](https://kennethburris.com/data-becoming-form-series/) — Oil painting informed
  by landscapes and verified Bitcoin block data. Also a BFTA Board Advisor, see
...
- [The Great Print](https://timechainartmagazine.com/artist/the-great-print/) — Detailed pen
  ...
  companies.
- [Bitko Yinowsky](https://bitko.cc/) — Conceptual, primarily digital Bitcoin character art; a
  fictional persona representing decentralization, scarcity, and resistance.
...
- [Dustin D. Trammell](https://timechainartmagazine.com/artist/dustin-trammell/) — Experimental
  ...
  specified).
- [Missatoshi_girl](https://missatoshigirl.pvh-labs.com/) — Street-art-influenced mixed media
  using recycled and repurposed materials; graffiti language addressing privacy and freedom.
...
- [Chiefmonkey](https://hodlr.rocks/) — Laser-cut, layered digital-to-physical works combining
  text and symbolism; closely tied to cypherpunk philosophy and Nostr.
  ([Nostr](https://primal.net/p/npub1a3um269aaf3u5cy37kuykrrrnsg2pyv7za06pxjduv25lq5sdujs2qmdj6))
- [House of Ralfus](https://houseofralfus.com/) — Relief block printing, painting, and drawing;
  1/1 prints made on an 1860s Albion Press with rare handmade papers.
...
- [Marcus Connor](https://timechainartmagazine.com/artist/marcus-connor/) — Wood, installations,
  and music. Illustrated the "Bitcoin Roller Coaster Guy" meme; released the album *Blues Before
  Bitcoin* (2024).
...
- [Juliette Garzón (Juls)](https://bitcoinartgallery.com) — Pop art and sculpture, Venezuelan.
  Represented by Bitcoin Art Gallery Wynwood.
- [Lady RedHorns](https://redhornsbtc.store/) — Mixed media, "Angels of Freedom" series ("The
  Transfer of Light", "The Bitcoin Keeper", "The Temptation of Bitcoin Angel"). Auctioned via
  Bitcoin for the Arts. ([Instagram](https://www.instagram.com/lady_redhorns), [X/Twitter](https://x.com/LRedhorns))
...
### Other / Studio & Sidework

Bitcoin-adjacent product lines and commercial studio projects — not individually authored art,
but part of the same creative economy.

- [Bitcoin Trading Cards](https://basedtradingcards.com/) — Physical collectible card line and
  storytelling; limited editions present Bitcoin culture through scarcity and proof-of-work themes.
  ([X/Twitter](https://x.com/btc_cards), [Nostr](https://primal.net/p/npub1yjryjq2kdganuc69zme9agk0q4rjcnlxel3fwp3xm9z68phsxngsqd33a9))
- [Bitchair](https://bitchair.store/) — Functional furniture line using woodworking, fabrics, and
  embroidery; each limited chair is designed to be both usable furniture and Bitcoin merch.

### Institutions & Spaces

- [BMAG — Bitcoin Museum & Art Gallery](https://museum.b.tc) — Nashville, TN. Physical museum and
  auction platform, 170+ works, subsidiary of BTC Inc. Houses Hal Finney/Ross Ulbricht memorabilia.
- [Bitcoin Art Society](https://www.bitcoinartsociety.com) — Curator-led institution. Runs the
  Robert Mallary Art Residency; exhibits at NFC Summit, Bitcoin Asia, Ordinals Buenos Aires.
...
- [Timechain Art Magazine](https://timechainartmagazine.com) — Publisher and directory hub; see
  full entry under [Publications & Media](#publications--media).
...
- [Bitcoin FilmFest](https://bitcoinfilmfest.com) — Warsaw-based hub for the Bitcoin cinema
  industry; festival, network, and archive. Full entry under [Events & Festivals](#events--festivals).
...
- [Adam Kadmon](https://adamkadmon.my.canva.site/bitcoinart) — Carved wood panels and mixed-media
  sculpture using gilding, acrylic, and engraved text; "The Bitcoin Religion" series.
- [Puzzle](https://puzzlingpuzzle.art/) — Laser-cut wood sculpture with layered construction and
  embedded LED lighting; digital vector designs become luminous physical pieces.
- [MadMunky](https://madmunky2140.carrd.co/) — Wood, resin, and mixed-media sculpture with sound
  and video extensions; "Manifesto 2140" series uses oak, epoxy, and hardwax oil.
...
- **[Bitcoin for the Arts (BFTA)](https://www.bitcoinforthearts.org/)** — US 501(c)(3) nonprofit
  paying working artists exclusively in Bitcoin via quarterly micro-grants; runs Bitcoin Arts Park
  at partner conferences. Founded 2025 by Dion Wilson.
...
- **[Bitcoin FilmFest](https://bitcoinfilmfest.com)** — "The heart of Bitcoin Cinema." Annual
  Warsaw festival (Kinoteka) screening Bitcoin films and awarding the Golden Rabbits.
...
named-creator rule for other sections. This section is deliberately looser: entries here don't
...
- [Maxis Club](https://maxisclub.carrd.co/) — Meme art, humor, and satire; daily collection
  aiming for 2,100 limited memes tied to Bitcoin's 21-million supply cap.
...
to this work. See [LICENSE](LICENSE).
